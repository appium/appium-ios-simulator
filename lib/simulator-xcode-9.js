...
class SimulatorXcode9 extends SimulatorXcode8 {
  ...
  async run (opts = {}) {
    ...
    if (opts.simWindowCenter && opts.simWindowCenter.x && opts.simWindowCenter.y) {
      opts.devicePreferences.SimulatorWindowCenter = `{${opts.simWindowCenter.x},${opts.simWindowCenter.y}}`;
    } else {
