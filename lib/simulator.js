 ...
 * @return {Promise<GenericSimulator>} Simulator object associated with the udid passed in.
 */
 ...
 * & import('./types').HasSettings
 * & import('./types').InteractsWithApps
 * & import('./types').SupportsBiometric
 * & import('./types').SupportsGeolocation
 * & import('./types').InteractsWithKeychain
 * & import('./types').SupportsAppPermissions
 * & import('./types').HasMiscFeatures} GenericSimulator
 */