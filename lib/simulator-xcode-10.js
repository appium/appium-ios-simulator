...
export class SimulatorXcode10 extends EventEmitter {
   ...
   *
   * @return {Promise<import('@appium/types').StringRecord>} Simulator stats mapping, for example:
   * { name: 'iPhone 4s',
  ...
  async run (opts = {}) {
    ...
    const [devicePreferences, commonPreferences] = settingsExtensions.compileSimulatorPreferences(opts);
  ...
  verifyDevicePreferences = settingsExtensions.verifyDevicePreferences;
  updatePreferences = settingsExtensions.updatePreferences;
