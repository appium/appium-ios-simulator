...
const PREFERERENCES_PLIST_GUARD = new AsyncLock();
const DOMAIN_KEYBOARD_PREFERENCES = 'com.apple.keyboard.preferences';
const DOMAIN_ACCESSIBILITY = 'com.apple.keyboard.preferences';
...
export async function setReduceMotion (reduceMotion) {
  return await this.updateSettings(DOMAIN_ACCESSIBILITY, {
...
export async function disableKeyboardIntroduction () {
  return await this.updateSettings(DOMAIN_KEYBOARD_PREFERENCES, {
...
export async function updatePreferences (devicePrefs = {}, commonPrefs = {}) {
  ...
  return await PREFERERENCES_PLIST_GUARD.acquire(this.constructor.name, async () => {
