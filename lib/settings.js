...
async function reduceMotion (sim, reduceMotion = true) {
  for (let file in await plistPaths(sim, 'accesibilitySettings')) {
    // plist = await read(file)
    let updates = {
...
export { update, updateSettings, updateLocationSettings, reduceMotion,
