...
class Certificate {
   ...
   */
  async add (dir) {
    this.data = await this.getDerData(this.pemFilename);
    this.subject = await this.getSubject(this.pemFilename);
    this.fingerprint = await this.getFingerPrint(this.data);
