...
import {createSimulator, listSimulators, killAllSimulators, simExists} from './utils/index.js';
...
export {getSimulator, killAllSimulators, simExists, createSimulator, listSimulators, BaseSimulator};
