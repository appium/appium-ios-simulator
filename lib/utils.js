...
async function installSSLCert (pemText, udid) {
  let tempFileName = `${__dirname}/temp-ssl-cert.pem`;
  // TODO: Confirm if this is universally applicable to all versions of OSX
  let pathToKeychain = `${process.env.HOME}/Library/Developer/CoreSimulator/Devices/${udid}/data/`;
