...
class SimulatorXcode6 extends EventEmitter {
  ...
  async enableCalendarAccess (bundleID) {
    await (new Calendar(this.getDir(), bundleID)).enableCalendarAccess();
  }

  async disableCalendarAccess (bundleID) {
    await (new Calendar(this.getDir(), bundleID)).disableCalendarAccess();
  }

  async hasCalendarAccess (bundleID) {
    return await (new Calendar(this.getDir(), bundleID)).hasCalendarAccess();
  }
