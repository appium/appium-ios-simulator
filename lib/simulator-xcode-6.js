...
class SimulatorXcode6 extends EventEmitter {
   ...
   */
  async activateWindow () { // eslint-disable-line require-await
    return `
  ...
  async executeUIClientScript (appleScript) {
    const windowActivationScript = await this.activateWindow();
   ...
   *
   * @throws {Error} If keyvhain cleanup has failed.
   */
