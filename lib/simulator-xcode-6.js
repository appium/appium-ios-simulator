...
import { fs, util, rimraf } from 'appium-support';
...
class SimulatorXcode6 {
  ...
  async run () {
    ...
    let checkBooted = async function () {
    ...
    await retryInterval(parseInt(BOOTING_TIMOUT/BOOTED_POLLING_INTERVAL), BOOTED_POLLING_INTERVAL, () => {
      return checkBooted();
    });
  }
